...
import { handleContractStatusChange, FetchContracts } from '../../api/services';
import {
  Button,
  Dialog,
  Card,
...
const handleOpen = () => setOpen((cur) => !cur);
  ...
  const onSubmit = async () => {
    try {
      console.log(values);
      const response = await handleContractStatusChange(values, token);
      ...
      console.log(error);
      handleOpen()
      toast.error("Couldn't add contract!!");
    }
  };
  ...
  <div className="max-w-full overflow-x-auto">
    {contracts?.length > 0 ?  <table className="w-full table-auto">
      <thead>
          ...
          <tr key={key}>
            ...
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              <p className="text-black dark:text-white">
                {contract.owner_or_agent}
              </p>
            </td>
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              <p className="text-black dark:text-white">
                {contract.buyer_or_renter}
              </p>
            </td>
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              <a 
                href={contract.preview_url} 
                target="_blank" 
            ...
            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
              ...
              >
                {contract.is_active ? 'active' : 'disabled'}
              </p>
            </td>
            {/* <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
    ...
    </table> : <p className='text-center text-title-md'>No contracts!!</p>}
