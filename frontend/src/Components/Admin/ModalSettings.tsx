      ...
      >&times;</strong>
        ...
        <div className="grid grid-cols-3 gap-5 justify-normal">
          <div className="form-group w-full col-span-3">
            ...
            <input className="w-full rounded border border-stroke bg-gray py-3 pl-3 pr-4.5 text-black focus:border-primary2focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
          ...
          <div className="form-group ">
            ...
            <div className="relative z-20 w-full rounded border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary2active:border-primary2dark:border-form-strokedark dark:bg-form-input">
          ...
          <br></br>
          <button className="btn flex justify-center rounded bg-primary2py-2 px-6 font-medium text-gray hover:shadow-1"
