  ...
  return (
    <div>
      ...
      <div className="relative">
        <input
          className="form-datepicker w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal outline-none transition focus:border-primary2active:border-primary2dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
