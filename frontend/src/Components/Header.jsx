    ...
    <nav className="bg-white border-gray-200 px-4 lg:px-6 py-5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <Link to='/' className='flex items-center'>
                ...
                <img src="/logoreb.png" className="mr-3 sm:w-9 w-6 h-9 sm:h-6" alt=" Logo" />
                <span className="self-center md:text-xl text-base font-semibold whitespace-nowrap dark:text-white">REApp</span>
            </Link>
   
            <div className="flex items-center lg:order-2">
                {token ?
<p className='mx-1 mr-3'><svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 24 24" fill="none" stroke="#1d4ed8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg></p>
                 :
                <Link to={'/login'} className='text-gray-800 dark:text-white hover:bg-gray-50  font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800'>Log in</Link>
